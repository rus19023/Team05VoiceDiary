...
public class GetAsyncTranscript implements Runnable {
    ...
    public  String requestTranscription () {
        Toast.makeText(context, "working conection to requestTranscription", Toast.LENGTH_SHORT).show();
    ...
    public String receiveText() {
        Toast.makeText(context, "working conection to  receiveText", Toast.LENGTH_SHORT).show();
